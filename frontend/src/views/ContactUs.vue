        ...
        <section id="contato" class="max-w-6xl mx-auto px-6 pt-24 scroll-mt-32">
            ...
            <div class="max-w-4xl mx-auto reveal-scale delay-100">
                <form @submit.prevent="sendEmail"
                    ...
                    <div class="md:col-span-1 reveal-element delay-300 relative z-10">
                        <label
                            class="block text-gray-700 font-bold mb-2 text-sm uppercase tracking-wide">Empresa</label>
                    ...
                    <div
                        class="md:col-span-2 flex flex-col sm:flex-row justify-between items-center gap-6 mt-4 relative z-10 reveal-element delay-500">
